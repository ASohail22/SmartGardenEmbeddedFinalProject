#include <msp430.h>
#define CALADC_15V_30C  *((unsigned int *)0x1A1A)                 // Temperature Sensor Calibration-30
//6682                                                                 // See device datasheet for TLV table memory mapping
//6684
...
void port_init()
{
    ...
    P1OUT |= BIT0;
    P1SEL1 |= BIT4;
    P1SEL0 |= BIT6 | BIT7 | BIT4;           // set 2-UART pin as second function
